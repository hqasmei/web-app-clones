    ...
    <section>
      <div className="py-36">
        <div className="mb-16 flex flex-col items-center justify-center space-y-16 text-center">
          <span className="px-24 text-5xl font-bold">
            Meet the people behind Truewind
          </span>
          <span className="px-24 text-2xl font-medium leading-10 text-gray-500">
            We love finance & accounting. We're a team of technology engineers
            with one shared goal: give you peace of mind
          </span>
        </div>
        <div className="flex flex-col items-start justify-start space-y-2 px-16">
      ...
      <div className="md:flew-row-reverse flex flex-col items-center px-8 py-36">
      ...
      <div className="flex flex-col items-center justify-center bg-[#ECF0F2] py-36">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-20">
          {team.map((item, idx) => (
            <div
              key={idx}
